        ...
        <main className="flex-1" role="main">
          ...
          <section
            className={cn(
              ...
              hasSearched ? "py-4 md:py-8" : "py-12 md:py-20 lg:py-28"
            )}
            style={{
              ...
              >
                ...
                >
                  <div className="space-y-4 max-w-3xl mx-auto">
                    ...
                    <p className="text-muted-foreground md:text-xl max-w-2xl mx-auto">
                      Easily download any public GitHub repository, folder, or
                      file without using Git or command line tools. Perfect for
                      developers, students, and code enthusiasts.
                    </p>
                  </div>
                  <nav
                  ...
                  >
                    <Button
                      size="lg"
                      className="gap-1 bg-primary hover:bg-primary/90 hover-lift"
                      aria-label="Start downloading GitHub repositories"
                    >
                    ...
                    >
                      <Link
                        to="/guide"
                        className="gap-1"
                        aria-label="Learn how RepoGrabber works"
                      >
                ...
                <div
                  className={cn(
                    ...
                    !hasSearched &&
                      "mt-8 bg-card/30 p-4 sm:p-6 rounded-xl border border-border/20 shadow-lg"
                  )}
                >
                  <RepoExplorer
                    onSearch={(hasResults) => setHasSearched(!!hasResults)}
                  />
                </div>
              </div>
            </div>
          ...
          <section
            className={cn(
              ...
              hasSearched
                ? "py-4 md:py-6 bg-card/50"
                : "py-8 md:py-12 lg:py-16 bg-card/50"
            )}
              ...
              <div className="mx-auto grid max-w-5xl items-center gap-6 py-6 md:py-12 lg:grid-cols-2 lg:gap-12">
                <header className="space-y-4">
                  ...
                  <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    RepoGrabber makes it easy to browse and download code from
                    GitHub without any technical knowledge or special tools.
                    Perfect for developers, students, and anyone working with
                    code.
                  </p>
                </header>
                <div
                ...
                >
                  <article
                    className="flex flex-col items-center gap-2 rounded-lg border border-border/40 bg-card p-4 text-center hover-scale shadow-sm"
                    role="listitem"
                  >
                    <div
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground">
                      Download specific folders as ZIP archives. Get only what
                      you need from large projects.
                    </p>
                  </article>
                  <article
                    className="flex flex-col items-center gap-2 rounded-lg border border-border/40 bg-card p-4 text-center hover-scale shadow-sm"
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground">
                      Download individual files directly to your device. No need
                      to clone entire repositories.
                    </p>
                  </article>
                  <article
                    className="flex flex-col items-center gap-2 rounded-lg border border-border/40 bg-card p-4 text-center hover-scale shadow-sm"
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground">
                      Track your recent downloads for easy access. Never lose
                      track of useful repositories.
                    </p>
                  </article>
                </div>
              </div>
          ...
          >
            <div className="container px-4 md:px-6 max-w-4xl mx-auto">
              <header className="text-center space-y-4 mb-8">
                ...
                <p className="text-muted-foreground">
                  Common questions about using RepoGrabber for GitHub downloads
                </p>
              </header>
              <FAQ />
            </div>
